...
globalkeys = gears.table.join(
    ...
    awful.key({ altkey }, "F4", function() awful.spawn(terminal .. " -e pulsemixer") end,
        { description = "application launcher", group = "launcher" }),
    awful.key({ modkey }, "w", function() awful.spawn("bookmark") end,
        { description = "application launcher", group = "launcher" }),
    ...
    -- Widgets
    -- Volumes
    awful.key({ altkey }, "F2", function() wibar.volume_widget:dec(5) end),
    awful.key({ altkey }, "F3", function() wibar.volume_widget:inc(5) end),
    ...
    awful.key({ altkey }, "F5", function() wibar.brightness_widget:dec() end),
    awful.key({ altkey }, "F6", function() wibar.brightness_widget:inc() end)
)
